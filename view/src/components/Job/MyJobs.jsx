...
const MyJobs = () => {
  ...
  //It is the Function For Disabling Editing Mode
  ...
  const handleUpdateJob = async (jobId) => {
    ...
    await axios
      .put(`http://localhost:8000/api/job/updatejobs/${jobId}`, updatedJob, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  //here is the Function For Deleting Job
  ...
  const handleInputChange = (jobId, field, value) => {
    // Now we Update the job object in the jobs state with the new value
    setMyJobs((prevJobs) =>
      prevJobs.map((job) =>
